...
color4 material_diffuse[8] = {color4(0.01, 0.01, 0.01, 1.0 ), color4(0.1, 0.35, 0.1, 1.0 ), color4(  0.9, 0.68, 0.0, 1.0 ), color4(0.5, 0.0, 0.0, 1.0 ),
    color4( 0.4, 0.1, 0.5, 1.0 ), color4( 0.9, 0.42, 0.65, 1.0 ), color4(0.75, 0.5, 0.2, 1.0 ), color4( 0.0, 0.50980392, 0.7, 1.0 )
};
